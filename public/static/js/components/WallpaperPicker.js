...
const __component = {
  ...
  data() {
    return { selected: "default", message: "Wallpaper is saved on this device.", wallpapers: [{ id: "default", name: "Default CSS" }, { id: "aurora", name: "Aurora" }, { id: "ocean", name: "Deep ocean" }, { id: "dusk", name: "Violet dusk" }, { id: "sunrise", name: "Solar sunrise" }, { id: "graphite", name: "Graphite" }] };
  },

  methods: {
    choose(id) {
      this.selected = id; window.FlxonOS.wallpapers.apply(id); this.message = "Saved locally.";
    },
    close() {
      window.dispatchEvent(new CustomEvent("flaxon:close-wallpapers"));
    },
  },

  template: `<section class="wallpaper-panel window stack"><div class="editor-heading"><div><h2>Appearance</h2><p class="muted">Choose a local desktop wallpaper.</p></div><button @click="close">Close</button></div><div class="wallpaper-grid"><button class="wallpaper-card" data-wallpaper="default" data-teloce-bind-class="{ selected: selected === &#x27;default&#x27; }" @click="choose('default')"><span>Default CSS</span></button><button class="wallpaper-card" data-wallpaper="aurora" data-teloce-bind-class="{ selected: selected === &#x27;aurora&#x27; }" @click="choose('aurora')"><span>Aurora</span></button><button class="wallpaper-card" data-wallpaper="ocean" data-teloce-bind-class="{ selected: selected === &#x27;ocean&#x27; }" @click="choose('ocean')"><span>Deep ocean</span></button><button class="wallpaper-card" data-wallpaper="dusk" data-teloce-bind-class="{ selected: selected === &#x27;dusk&#x27; }" @click="choose('dusk')"><span>Violet dusk</span></button><button class="wallpaper-card" data-wallpaper="sunrise" data-teloce-bind-class="{ selected: selected === &#x27;sunrise&#x27; }" @click="choose('sunrise')"><span>Solar sunrise</span></button><button class="wallpaper-card" data-wallpaper="graphite" data-teloce-bind-class="{ selected: selected === &#x27;graphite&#x27; }" @click="choose('graphite')"><span>Graphite</span></button></div><p class="muted">{{ message }}</p></section>`,
};
...
const __template = "<section class=\"wallpaper-panel window stack\"><div class=\"editor-heading\"><div><h2>Appearance</h2><p class=\"muted\">Choose a local desktop wallpaper.</p></div><button @click=\"close\">Close</button></div><div class=\"wallpaper-grid\"><button class=\"wallpaper-card\" data-wallpaper=\"default\" data-teloce-bind-class=\"{ selected: selected === &#x27;default&#x27; }\" @click=\"choose('default')\"><span>Default CSS</span></button><button class=\"wallpaper-card\" data-wallpaper=\"aurora\" data-teloce-bind-class=\"{ selected: selected === &#x27;aurora&#x27; }\" @click=\"choose('aurora')\"><span>Aurora</span></button><button class=\"wallpaper-card\" data-wallpaper=\"ocean\" data-teloce-bind-class=\"{ selected: selected === &#x27;ocean&#x27; }\" @click=\"choose('ocean')\"><span>Deep ocean</span></button><button class=\"wallpaper-card\" data-wallpaper=\"dusk\" data-teloce-bind-class=\"{ selected: selected === &#x27;dusk&#x27; }\" @click=\"choose('dusk')\"><span>Violet dusk</span></button><button class=\"wallpaper-card\" data-wallpaper=\"sunrise\" data-teloce-bind-class=\"{ selected: selected === &#x27;sunrise&#x27; }\" @click=\"choose('sunrise')\"><span>Solar sunrise</span></button><button class=\"wallpaper-card\" data-wallpaper=\"graphite\" data-teloce-bind-class=\"{ selected: selected === &#x27;graphite&#x27; }\" @click=\"choose('graphite')\"><span>Graphite</span></button></div><p class=\"muted\">{{ message }}</p></section>";
const __style = "";
...
const __initialData = { selected: "default", message: "Wallpaper is saved on this device.", wallpapers: [{ id: "default", name: "Default CSS" }, { id: "aurora", name: "Aurora" }, { id: "ocean", name: "Deep ocean" }, { id: "dusk", name: "Violet dusk" }, { id: "sunrise", name: "Solar sunrise" }, { id: "graphite", name: "Graphite" }] };
...
const __installStyle = () => {
  ...
  const styleId = "teloce-style-be27125a0";
