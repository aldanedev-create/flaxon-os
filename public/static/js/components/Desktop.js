...
const __component = {
  ...
  methods: {
    ...
    launch(event) {
      const view = event?.currentTarget?.dataset?.view; if (view) this.open(view);
    },
    closeStart() {
