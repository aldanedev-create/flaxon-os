...
const __component = {
  ...
  mounted() {
    document.body.classList.add("desktop-mode"); document.body.dataset.view = this.view; this.loadNotes(); this.measure(); this.setModuleVisibility(this.view); window.addEventListener("flaxon:navigate", event => this.open(event.detail)); window.addEventListener("flaxon:external", event => this.openExternal(event.detail));
  },
